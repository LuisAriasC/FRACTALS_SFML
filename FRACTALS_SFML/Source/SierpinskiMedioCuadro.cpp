...
void SierpinskiMedioCuadro::Render(sf::RenderWindow& window) //OBTIENE UN RENDERWINDOW
...
void SierpinskiMedioCuadro::setColor(const sf::Color& newColor) //DA EL COLOR PRINCIPAL ** VER SI SE USA OTRA VEZ
{
    m_color = sf::Color(newColor);
}

sf::Color SierpinskiMedioCuadro::getColor() const //OBTIENE EL COLOR *** VER DONDE SE USA
{
    return m_color;
}
