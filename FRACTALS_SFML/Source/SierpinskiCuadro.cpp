...
void SierpinskiCuadro::Render(sf::RenderWindow& window) //OBTIENE UN RENDERWINDOW
...
void SierpinskiCuadro::setColor(const sf::Color& newColor) //DA EL COLOR PRINCIPAL ** VER SI SE USA OTRA VEZ
{
    m_color = sf::Color(newColor);
}

sf::Color SierpinskiCuadro::getColor() const //OBTIENE EL COLOR *** VER DONDE SE USA
{
    return m_color;
}
